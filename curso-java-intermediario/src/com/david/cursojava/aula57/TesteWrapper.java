package com.david.cursojava.aula57;
...
public class TesteWrapper {
    ...
    public static void main(String[] args) {
        ...
        Short num7 = new Short((short) 1); //classes wrappers
        ...
        Integer num18 = Integer.valueOf(1288);
        System.out.println(num18);

        System.out.println(num9 == num13); //usar equals para comparar instancias de classes
    }
}
